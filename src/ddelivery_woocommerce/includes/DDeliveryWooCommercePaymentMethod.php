...
function addDDeliveryPaymentMethod()
{
	...
	function _initDDeliveryPaymentMethod()
	{
		...
		{
			const TITLE = 'Payment via DDelivery';
			
			public function __construct()
			{
				$this->id                 = DDeliveryWooCommerceBase::ID;
				$this->method_title       = __(self::TITLE, DDeliveryWooCommerceBase::TEXT_DOMAIN);
				...
				if (!$this->title)
				{
					$this->update_option('title', __(self::TITLE, DDeliveryWooCommerceBase::TEXT_DOMAIN));
					$this->title = __(self::TITLE, DDeliveryWooCommerceBase::TEXT_DOMAIN);
				}
